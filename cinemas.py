...
def fetch_movie_info(movie_name):
    ...
    response = requests.get(url, params=params, headers=headers, timeout=5.9)
    ...
    rating_and_votes_amount_list = element_most_wanted.find_all('div', 'rating ratingGreenBG')[0].attrs['title'].split(' ')
...
if __name__ == '__main__':
    ...
    dict_name_rating = make_dict_name_rating(['Притяжение', 'Три икса: Мировое господство', 'Ла-Ла Ленд'])
    print(dict_name_rating)
    #top10_list = make_top_list(dict_name_rating, 10)
